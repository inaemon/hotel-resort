...
<style>
body,html{
	background-image: url("../resources/images/background/ocean2.png");
	background-size: cover;
	}
#div_content li{
	background-color: #72dee1;
	}
</style>
<meta charset="UTF-8">
...
<body>
<div>
<!-- <div style="display: table; margin-left: auto; margin-right: auto;"> <!-- array center -->
<!-- <body background="<c:url value='/resources/images/black.jpg' />"> -->
	...
	<div id="div_content">
		<b class="title" style="color:#72e1d3; filter: drop-shadow(0px 10px 20px white)">WATER PARK</b>
		<div id="div_list">
			<ul>
				<!-- id="" only one, Don't apply all li -->
				<li class="liststart" style="background-color: white"><p onclick="water(1)" style="color:#72dee1">Schlitterbahn</p></li>	<!-- First Come, Default Clicked Effect -->
		...
		<div id="div_content2">
			<!-- First Come, Default Schlitterbahn  //걍 아래 script에 있는 거 그대로 끌어옴 (copy&paste) -->
				<br><br><br><img style='width:600px' src='../../resources/images/waterzone/water_schlitterbahn4.png'>
			<br><b style='font-size:27px; color:#838383'>wave & swing collaboration!!</b>
			<br><b style='font-size:27px; color:#59d6dc; filter: drop-shadow(0px 10px 20px #ffffff)'>Perfect Match!</b><br>
			...
			<br><br><b style='font-size:27px; color:#fbfbfb; filter: drop-shadow(0px 10px 20px #71e1bc); float: left; padding-left: 60px'>Make Various Experience&nbsp;</b>
				<!--pageIcon-->
...
<script>
	...
	var image1 = "<br><br><br><img style='width:600px' src='../../resources/images/waterzone/water_schlitterbahn4.png'>";
	var div1 = "<br><b style='font-size:27px; color:#838383'>wave & swing collaboration!!</b>";
	div1+= "<br><b style='font-size:27px; color:#59d6dc; filter: drop-shadow(0px 10px 20px #ffffff)'>Perfect Match!</b><br>";
	...
	div1+="<br><br><b style='font-size:27px; filter: drop-shadow(0px 10px 20px #fbfbfb); color:#c5f2ef; float: left; padding-left: 60px'>Make Various Experience&nbsp;</b>";
		/*pageIcon*/
	...
	function water(n){
		...
		for(var i=0; i<cli.length; i++){
			cli[i].style.backgroundColor="#72dee1";
			ca[i].style.color="white";
		}
		
		cli[n-1].style.backgroundColor="white";
		ca[n-1].style.color="#72dee1";
