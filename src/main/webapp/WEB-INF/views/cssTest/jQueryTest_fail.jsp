...
function img(){
	if($("#jbtn2").attr('disable',false)){
		$("#jbtn2").css('color','rgba(30, 22, 54, 0.6)');
		$("#jbtn2").css('box-shadow',"rgba(30, 22, 54, 0.4) 0 0px 0px 2px inset");
		/*Button 비활성화*/
		$("#jbtn2").attr('disable', true);
	}
		else{
